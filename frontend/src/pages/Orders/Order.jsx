    ...
    <div className="container flex flex-col ml-[10rem] md:flex-row mt-5">
          ...
          {order.orderItems.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-[80%]">
                <thead className="font-varela bg-pink-100">
                  <tr>
      ...
      <div className="md:w-1/3">
        <div className="mt-5 border-gray-300 pb-4 mb-4">
          <h2 className="text-xl font-bold mb-2 font-varela">Shipping</h2>
        ...
        <h2 className="text-xl font-bold mb-2 mt-[3rem] font-varela">Order Summary</h2>
        ...
        {userInfo && userInfo.isAdmin && order.isPaid && !order.isDelivered && (
          <div>
            <button
              type="button"
              className="bg-pink-700 text-white w-full py-2 hover:brightness-125 hover:scale-105 rounded-full transition-transform"
