...
const Navigation = () => {
    ...
    return <div 
                style={{zIndex: 999}} 
                className={`${showSidebar ? 'hidden' : 'flex'} xl:flex lf:flex md:hidden sm:hidden flex-col justify-between p-4 text-white bg-black w-[4%] hover:w-[15%] h-[100vh] fixed`}
        ...
        <div className="relative">
            ...
            {dropdownOpen && userInfo && (
                <ul className={`absolute right-0 mt-2 mr-14 space-y-2 bg-gray-800 text-gray-200 
