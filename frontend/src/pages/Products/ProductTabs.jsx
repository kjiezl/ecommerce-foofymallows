                        ...
                        <form onSubmit={submitHandler}>
                            <div className="my-2">
                                ...
                                <select 
                                    ...
                                    className="p-2 border rounded-lg xl:w-[40rem] text-black bg-white">
                            ...
                            <button
                                ...
                                className="bg-pink-600 text-white py-2 px-4 rounded-lg hover:scale-110 hover:bg-pink-800 transition-transform">
                                    Submit
                            </button>
                        </form>
                    ) : (
                        <p>Please <Link to='/login' className="text-pink-500 hover:underline">login</Link> or <Link to='/register' className="text-pink-500 hover:underline">sign up</Link> to write your review.</p>
                    )}
                </div>
            )}
        </section>
                    ...
                    <div>
                        {product.reviews.map((review) => (
                            <div 
                                ...
                                <p className="my-4 text-gray-800">{review.comment}</p>
